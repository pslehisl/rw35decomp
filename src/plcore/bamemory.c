                  ...
                  RwUInt32 lineCreate)
{
    ...
    freelist = FreeListCreate(entrySize, entriesPerBlock, alignment, 1, NULL);
                 ...
                 RwInt32 alignment)
{
    ...
    RWASSERT(entriesPerBlock);
    RWASSERT(!(alignment & (alignment - 1))); /* Assert power of 2 */
    RWRETURN(FreeListCreate(entrySize, entriesPerBlock, alignment, 1, NULL));
}
                                    ...
                                    RwFreeList *inPlaceSpaceForFreeListStruct)
{
    ...
    RWRETURN(FreeListCreate(entrySize, entriesPerBlock, alignment,
        numBlocksToPreallocate, inPlaceSpaceForFreeListStruct));
}
...
static void *
HRealloc(void *mem, size_t newSize)
{
...
static void *
HCalloc(size_t numObj, size_t sizeObj)
{
